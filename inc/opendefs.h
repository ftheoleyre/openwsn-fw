...
enum {
   ...
   ERR_SIXTOP_CHANGESTATE              = 0x58, // sixtop FSM state changed {0} -> {1}
   ERR_IEEE154_CHANGESTATE             = 0x59, // IEEE 802.15.4 FSM state changed {0} -> {1}
#ifdef CCA_BEFORE_ACK
   ERR_WRONG_STATE_IN_CCAEND           = 0x5a, // wrong state {0} in CCA_END, with CCA code result {1}
   ERR_PRIMARY_ANYCAST                 = 0x5b, // I'm not the primary rcvr: I will forward={0}, cca result={1}
#endif
